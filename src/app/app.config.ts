...
export class AppConfig {
  config = {
    name: 'dl',
    title: 'DemandLocal Demo Dashboard',
    version: '1.0',
    edmundsDealerServiceUrl: 'http://api.edmunds.com/api/dealer/v2/dealers/?zipcode=ZIP&radius=RAD&state=new&pageNum=1&pageSize=10&sortby=distance%3AASC&view=basic&api_key=cabx8djg37x6x47sr9hyz24g',
